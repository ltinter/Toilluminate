    ...
    var methods = {
        ...
        addNewGroup: function () {
            ...
            Settings = {
                ...
                TuesdayisCheck: $("#player_tuesday").is(':checked'),
                Tuesday: $("#player_tuesday_value").val(),
                WednesdayisCheck: $("#player_wednesday").is(':checked'),
                Wednesday: $("#player_wednesday_value").val(),
                ThursdayisCheck: $("#player_thursday").is(':checked'),
                Thursday: $("#player_thursday_value").val(),
                FridayisCheck: $("#player_friday").is(':checked'),
                Friday: $("#player_friday_value").val(),
                SaturdayisCheck: $("#player_saturday").is(':checked'),
                Saturday: $("#player_saturday_value").val(),
                SundayisCheck: $("#player_sunday").is(':checked'),
